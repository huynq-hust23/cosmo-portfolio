        ...
        <section id="projects"
            ...
            <div className="container mx-auto max-w-5xl">
                            ...
                            <div className="p-6">
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag) => (
                                        <span className="px-2 py-1 text-xs font-medium rounded-full bg-secondary bordered">{tag}</span>
                                    ))}
                                </div>
                ...
                <div className="text-center mt-12">
                    <a href="https://github.com/huynq-hust23"
                        target="_blank"
                        className="cosmic-button w-fit flex items-center mx-auto gap-2">Ckeck My Github <ArrowRight /> </a>
                </div>
