...
const skills = [
    ...
    { name: "PostgreSQL", level: "60", category: "SQL" },
    { name: "Prisma", level: "85", category: "SQL" },
    ...
    { name: "Adobe Lightroom", level: "80", category: "tools" }
            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredSkills.map((skill, index) => (
                        <div key={index} className="bg-card p-6 rouded-lg shadow-xs card-hover">
